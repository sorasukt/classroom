...
- **อีเมล `*.ac.th` ที่ยืนยันอีเมลแล้วและมี role Admin:** จัดการข้อมูลร่วมของโดเมนโรงเรียน เพิ่ม/ลบห้องเรียนและนักเรียน ตั้งค่าข้อมูล และ Import CSV ได้
- **อีเมล `*.ac.th` ที่ยืนยันอีเมลแล้วแต่ไม่มี role Admin:** ดูข้อมูล เช็คชื่อ จัดการแผนการสอน รายงาน และแชร์ได้ แต่ API จะปฏิเสธการเพิ่ม/ลบห้องเรียนและนักเรียน
