...
async function renderCheckinPage(request, env, token) {
  ...
  if (!open) return new Response(checkinHtml("ปิดรับเช็คชื่อแล้ว", "QR นี้หมดอายุหรือครูปิดรับเช็คชื่อแล้ว", "", "error"), { status: 410, headers: publicHtmlHeaders() });
  const device = await checkinDevice(request, env);
  const deviceHash = await sha256Hex(`${session.tenant_key}\0${device.id}`);
...
function checkinHtml(title, subtitle, content, tone = "") {
  ...
  :root{--ink:#050505;--paper:#fff;--surface:#fafafa;--red:#ff1010;--green:#00b51a;--line:#161514}*{box-sizing:border-box}html,body{margin:0;width:100%;height:100%;overflow:hidden}body{display:grid;place-items:center;padding:clamp(18px,6.5vh,72px) clamp(18px,10.5vw,184px);background:var(--surface);color:var(--ink);font-family:"IBM Plex Sans Thai",sans-serif;-webkit-font-smoothing:antialiased}main{display:grid;place-items:center;width:100%;height:100%}.card{display:flex;flex-direction:column;align-items:center;justify-content:center;width:100%;height:100%;max-width:1360px;max-height:830px;padding:clamp(30px,5vh,64px) clamp(24px,6vw,96px);overflow:hidden;border-radius:36px;background:var(--paper);box-shadow:0 10px 40px rgba(0,0,0,.025);text-align:center}.logo{display:block;width:150px;height:150px;margin:0 0 36px;border-radius:18px;object-fit:cover}h1{margin:0;font:600 clamp(34px,3.1vw,50px)/1.15 Kanit;letter-spacing:-.02em}header>p{max-width:900px;margin:22px auto 0;font-size:clamp(22px,1.9vw,32px);line-height:1.35}.error{color:var(--red)!important}.success-tone{color:var(--green)!important}.form-area{width:min(638px,100%);margin-top:58px}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}input,.code-preview,.subject-box{display:flex;align-items:center;justify-content:center;width:100%;height:142px;padding:12px 30px;border:1.5px solid var(--line);border-radius:18px;background:#fff;color:var(--ink);text-align:center}.code-input{font:600 clamp(50px,5vw,72px)/1 Kanit;letter-spacing:.58em;padding-left:calc(30px + .58em)}.student-code,.code-preview,.subject-box{font:600 clamp(28px,2.3vw,38px)/1.2 Kanit}.student-code::placeholder{color:#111;opacity:1}input:focus{outline:3px solid #ddd;outline-offset:2px}button{display:flex;align-items:center;justify-content:center;width:307px;height:76px;margin:30px auto 0;border:0;border-radius:30px;background:#000;color:#fff;font:600 clamp(26px,2vw,36px)/1 Kanit;cursor:pointer}button.danger{background:var(--red)}button:disabled{opacity:.55;cursor:wait}.confirm-actions{display:grid;grid-template-columns:1fr 1fr;gap:30px}.confirm-actions button{width:100%}.subject-box{margin-top:0}#message{min-height:0;margin:0;color:var(--red)}@media(max-height:850px){.card{padding-block:28px}.logo{width:112px;height:112px;margin-bottom:22px}.form-area{margin-top:34px}input,.code-preview,.subject-box{height:112px}button{height:64px;margin-top:22px}}@media(max-width:700px){body{padding:12px}.card{border-radius:24px;padding:24px 18px}.logo{width:min(27vw,108px);height:min(27vw,108px);margin-bottom:22px}h1{font-size:clamp(28px,9vw,38px)}header>p{margin-top:14px;font-size:clamp(17px,5.4vw,24px)}.form-area{margin-top:34px}input,.code-preview,.subject-box{height:96px;border-radius:14px;padding-inline:14px}.code-input{font-size:clamp(38px,13vw,58px);letter-spacing:.32em;padding-left:calc(14px + .32em)}.student-code,.code-preview,.subject-box{font-size:clamp(22px,7vw,30px)}button{width:min(307px,82%);height:60px;margin-top:22px;border-radius:24px;font-size:26px}.confirm-actions{gap:10px}.confirm-actions button{width:100%}}@media(max-width:700px) and (max-height:620px){.logo{width:70px;height:70px;margin-bottom:10px}.form-area{margin-top:18px}header>p{margin-top:8px}input,.code-preview,.subject-box{height:72px}button{height:50px;margin-top:12px}.card{padding-block:14px}}
